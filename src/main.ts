...
async function bootstrap() {
    ...
    helmet({
      contentSecurityPolicy: {
        directives: {
          ...
          connectSrc: ["'self'", 'http://localhost:5173', 'http://localhost:5174', 'http://use2mindstixassetmgmtalb-2121176886.us-east-2.elb.amazonaws.com'],
        },
      },
  ...
  const allowedOrigins = isProduction
    ...
    : ['http://localhost:5173', 'http://localhost:5174', 'http://use2mindstixassetmgmtalb-2121176886.us-east-2.elb.amazonaws.com'];
