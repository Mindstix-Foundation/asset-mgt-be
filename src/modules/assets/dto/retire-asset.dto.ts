...
export class RetireAssetDto {
  ...
  @IsEnum(['END_OF_LIFE', 'DAMAGED_BEYOND_REPAIR', 'OBSOLETE', 'COST_INEFFECTIVE', 'SECURITY_CONCERNS', 'OTHER'], { message: 'Invalid retirement reason' })
  retirementReason: string;

  @ApiPropertyOptional({
    description: 'Additional notes about the retirement',
    example: 'Asset has reached end of life and is no longer supported by manufacturer'
  })
  @IsOptional()
  @IsString()
