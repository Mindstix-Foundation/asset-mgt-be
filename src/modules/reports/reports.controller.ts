...
export class ReportsController {
    ...
    schema: {
      example: {
        ...
        data: {
          ...
          mimeType: 'text/csv',
          content: 'QXNzZXQgSUQsU2VyaWFsIE51bWJlcixDYXRlZ29yeSxBc3NldCBUeXBlLEJyYW5kLE1vZGVsLENvbmRpdGlvbixTdGF0dXMsLi4u',
          recordCount: 150,
  ...
  @ApiResponse({ 
    ...
    schema: {
      example: {
        message: 'Error generating report: Unsupported report type: invalid-type',
        error: 'Bad Request',
        statusCode: 400
      }
    }
